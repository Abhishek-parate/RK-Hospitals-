...
<head>
    ...
    <meta name="description" content="Contact Dr. Agrawal's R.K. Hospital Nagpur. Book appointment for Orthopedic Surgery, Robotic Knee Replacement, Gynecology & Pregnancy Care. Call +91 97660 57372. Located at Central Avenue, Nagpur.">
    <meta name="keywords" content="RK Hospital Nagpur contact, Dr Agrawal hospital appointment, orthopedic hospital contact Nagpur, gynecology hospital Nagpur, contact RK hospital">
    ...
    <meta property="og:description" content="Book appointment for Orthopedic Surgery, Robotic Knee Replacement, Gynecology & Pregnancy Care. Available 24/7.">
    ...
    <div class="main-wrapper">
        ...
        <section class="contact-hero-banner">
            ...
            <div class="banner-content">
                ...
                <p class="banner-sub">
                    Book an appointment for Orthopedic Surgery, Robotic Knee Replacement, Gynecology & Pregnancy Care. Available 24/7 for emergencies.
                </p>
                        ...
                        <div class="row g-3">
                            <div class="col-12 wow fadeInLeft" data-wow-duration="0.8s">
                                <div class="contact-info-card">
                                    <div class="card-badge"><i class="fa-solid fa-location-dot"></i> Hospital Location</div>
                                    ...
                                    <a href="https://maps.google.com/?q=Dr.Agrawal%27s+R.K.Hospital+Nagpur" target="_blank" rel="noopener" style="color:var(--red); font-weight:700; margin-top:8px; display:inline-flex; align-items:center; gap:6px; font-size:13px;">
                            ...
                            <div class="col-12 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.1s">
                                <div class="contact-info-card">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <a href="tel:+919766057372" style="font-weight:700; font-size:16px; color:var(--red);">+91 97660 57372</a>
                                    <a href="tel:+918999290433" style="font-weight:700; font-size:16px; color:var(--text-mid); margin-top:4px;">+91 89992 90433</a>
                                    <p style="margin-top:10px; font-size:12.5px; color:var(--text-soft);">Available 24/7 for Emergency · OPD: 11AM–4PM & 7PM–9PM</p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                <div class="contact-info-card">
                                    ...
                                    <table class="opd-table">
                                        <tr><td>Monday – Saturday</td><td>11AM – 4PM</td></tr>
                                        <tr><td>Monday – Saturday</td><td>7PM – 9PM</td></tr>
                                        <tr><td>Sunday</td><td>By Appointment</td></tr>
                                        <tr><td>Emergency Services</td><td><span class="open-badge">24/7 Open</span></td></tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="col-12 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                <div class="sidebar-card">
                                    ...
                                    <div class="social-links-grid">
                                        ...
                                        <a href="https://wa.me/919766057372" class="social-link-card wa" target="_blank">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-duration="0.8s">
                        <div class="form-section-wrap">
                            <div class="form-section-header">
                                ...
                                <p>Fill in the form and our team will get back to you within 30 minutes during OPD hours.</p>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="rk-form-group">
                                                ...
                                                <input type="text" name="name" class="rk-form-control" placeholder="e.g. Ramesh Sharma" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="rk-form-group">
                                                <label>Phone Number <span class="req">*</span></label>
                                                <input type="tel" name="phone" class="rk-form-control" placeholder="+91 XXXXX XXXXX" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="rk-form-group">
                                                <label>Email Address</label>
                                                <input type="email" name="email" class="rk-form-control" placeholder="your@email.com">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="rk-form-group">
                                            ...
                                            <div class="rk-form-group">
                                                ...
                                                <div class="service-checkboxes">
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s1" name="service[]" value="Robotic Knee Replacement">
                                                        <label for="s1">Robotic Knee Replacement</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s2" name="service[]" value="Hip Replacement">
                                                        <label for="s2">Hip Replacement Surgery</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s3" name="service[]" value="Spine Surgery">
                                                        <label for="s3">Spine & Back Pain</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s4" name="service[]" value="Fracture & Trauma">
                                                        <label for="s4">Fracture & Trauma Care</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s5" name="service[]" value="Pregnancy Care">
                                                        <label for="s5">Pregnancy & Delivery</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s6" name="service[]" value="Gynecology">
                                                        <label for="s6">Gynecology / PCOS</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s7" name="service[]" value="Infertility">
                                                        <label for="s7">Infertility Treatment</label>
                                                    </div>
                                                    <div class="service-checkbox-item">
                                                        <input type="checkbox" id="s8" name="service[]" value="Laparoscopy">
                                        ...
                                        <div class="col-md-12">
                                            <div class="rk-form-group">
                                                ...
                                                <textarea name="message" class="rk-form-control" placeholder="Briefly describe your condition or any specific queries..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class="row g-4">
                    <div class="col-lg-6 wow fadeInUp" data-wow-duration="0.8s">
                        <div class="doctor-contact-card">
                            <div class="doc-avatar-ring">
                                <img src="assets/img/home/doctor1.webp" alt="Dr. Priyanka Jain Agrawal Best Gynecologist Nagpur">
                                <div class="doc-specialty-dot"></div>
                            </div>
                            <div class="doctor-contact-info">
                                <h5>Dr. Priyanka Jain Agrawal</h5>
                                <div class="spec">Gynecologist & Obstetrician · MBBS, MD</div>
                                <div class="doc-contact-links">
                                    <a href="tel:+919766057372" class="doc-link-pill call">
                                        <i class="fa-solid fa-phone"></i> Call Now
                                    </a>
                                    <a href="gynecology-services.php" class="doc-link-pill appt">
                                        <i class="fa-solid fa-stethoscope"></i> View Services
                                    </a>
                                    <a href="https://wa.me/919766057372" class="doc-link-pill appt" target="_blank">
                                        <i class="fa-brands fa-whatsapp"></i> WhatsApp
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.15s">
                        <div class="doctor-contact-card">
                            <div class="doc-avatar-ring">
                                <img src="assets/img/home/doctor3.webp" alt="Dr. Rahul Agrawal Best Orthopedic Surgeon Nagpur">
                                <div class="doc-specialty-dot"></div>
                            </div>
                            <div class="doctor-contact-info">
                                <h5>Dr. Rahul R. Agrawal</h5>
                                <div class="spec">Orthopedic & Joint Replacement Surgeon · MS Ortho, FIJR</div>
                                <div class="doc-contact-links">
                                    <a href="tel:+918999290433" class="doc-link-pill call">
                                        <i class="fa-solid fa-phone"></i> Call Now
                                    </a>
                                    <a href="orthopedic-services.php" class="doc-link-pill appt">
                                        <i class="fa-solid fa-stethoscope"></i> View Services
                                    </a>
                                    <a href="https://wa.me/918999290433" class="doc-link-pill appt" target="_blank">
                                        <i class="fa-brands fa-whatsapp"></i> WhatsApp
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="emergency-cta wow fadeInUp" data-wow-duration="0.8s">
                            ...
                            <div class="emergency-text">
                                ...
                                <p>24/7 Emergency services for accidents, fractures, trauma, and pregnancy emergencies in Nagpur</p>
        ...
        <div class="map-section">
            <div class="container">
                ...
                <div class="map-iframe-wrap wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s" style="margin-bottom: 0; padding-bottom: 0;">
                    <iframe
        ...
        <div class="offcanvas-body">
            <div class="about-popup-item">
                ...
                <div class="about-img d-flex align-items-center gap-2 justify-content-between">
                    <img src="assets/img/home/about-doctor1.webp" alt="RK Hospital" class="img-fluid" style="border-radius:8px;">
                    <img src="assets/img/home/about-doctor2.webp" alt="RK Hospital" class="img-fluid" style="border-radius:8px;">
                    <img src="assets/img/home/about-doctor3.webp" alt="RK Hospital" class="img-fluid" style="border-radius:8px;">
                </div>
            </div>
            <div class="about-popup-item">
            ...
            <div class="about-popup-item border-0">
                ...
                <ul class="d-flex align-items-center gap-2 social-iyem">
                    ...
                    <li><a href="https://wa.me/919766057372" class="social-icon" target="_blank"><i class="fa-brands fa-whatsapp"></i></a></li>
                </ul>
            </div>
        </div>
