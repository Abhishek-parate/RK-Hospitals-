            ...
            <ul>
                ...
                <li<?= sbParent('doctors',$activePage) ?>>
                    <a href="#">
                        ...
                        <span>Doctors</span>
                        <span class="menu-arrow"><i class="fe fe-chevron-right" style="font-size:11px;"></i></span>
                    </a>
                    <ul style="display:<?= sbOpen('doctors',$activePage) ?>;">
                        <li>
                            <a href="<?= $adminBase ?>doctors/index.php">All Doctors</a>
                        </li>
                        <li>
                            <a href="<?= $adminBase ?>doctors/add.php">Add Doctor</a>
                        </li>
                    </ul>
                </li>
                ...
                <li<?= sbParent('users',$activePage) ?>>
                    ...
                    <ul style="display:<?= sbOpen('users',$activePage) ?>;">
                        <li>
                            <a href="<?= $adminBase ?>users/index.php">All Users</a>
                        </li>
                        <li>
                            <a href="<?= $adminBase ?>users/add.php">Add User</a>
                        </li>
                    </ul>
                </li>
                ...
                <li<?= sbParent('blogs',$activePage) ?>>
                    ...
                    <ul style="display:<?= sbOpen('blogs',$activePage) ?>;">
                        <li>
                            <a href="<?= $adminBase ?>blog/index.php">All Blogs</a>
                        </li>
                        <li>
                            <a href="<?= $adminBase ?>blog/add.php">Add Blog</a>
                        </li>
                    </ul>
                </li>
                ...
                <li<?= sbParent('services',$activePage) ?>>
                    ...
                    <ul style="display:<?= sbOpen('services',$activePage) ?>;">
                        <li>
                            <a href="<?= $adminBase ?>services/index.php">All Services</a>
                        </li>
                        <li>
                            <a href="<?= $adminBase ?>services/add.php">Add Service</a>
                        </li>
                    </ul>
                </li>
